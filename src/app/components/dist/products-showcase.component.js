        ...
        getProducts.forEach(function (product, index) {
            ...
            if (first < last) {
                if (getProducts[first] != undefined) {
                    ...
                    _this.rating.push(funciones_1.DinamicRating.fnc(getProducts[first]));
                    _this.reviews.push(funciones_1.DinamicReviews.fnc(_this.rating[index]));
                    _this.price.push(funciones_1.DinamicPrice.fnc(getProducts[first]));
...
=============================================*/
    ...
    ProductsShowcaseComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: '../pages/products-showcase.component.html',
            styleUrls: ['../styles/products-showcase.component.css']
        })
